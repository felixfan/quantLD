...
public class EM {
    ...
    private double[] esem(int[] gf, int[] gs, double[] h, double tol, int maxItr ){
        ...
        Excoffier-Slatkin EM algorithm for estimating haplotype frequencies.
        Input:
        gf: is array of genotype values at 1st locus, coded as 0, 1, and 2 to represent genotypes AA, Aa, and aa.
        gs: is the corresponding array for 2nd locus, coded as 0, 1, and 2 to represent genotypes BB, Bb, and bb.
        h: holds haplotype frequencies.  Initialized as {0.25, 0.25, 0.25, 0.25}
        tol: controls convergence.  Algorithm stops when sum of absolute differences between new and old haplotype frequencies is <= tol.
        maxItr: maximum iterate
        Output:
            hh, a array of 4 haplotype frequencies.
        */
    ...
    private double[] esemLD(int[] gf, int[] gs){
        ...
        gf: genotype code for the first SNP
        gs: genotype code for the second SNP
        */
